...
namespace API.Filters
{
    public class ApiExceptionFilterAttribute : ExceptionFilterAttribute
    {
        ...
        public ApiExceptionFilterAttribute()
        {
            ...
            {
                { typeof(InsertSQLFailureException), CreationFailException },
                { typeof(UpdateSQLFailureException), UpdateFailException },
        ...
        /// </summary>
        /// <param name="context">Context of exception</param>
        private void CreationFailException(ExceptionContext context)
        {
            var exception = context.Exception as InsertSQLFailureException;
        ...
        /// </summary>
        /// <param name="context">Context of exception</param>
        private void UpdateFailException(ExceptionContext context)
        {
            var exception = context.Exception as UpdateSQLFailureException;
